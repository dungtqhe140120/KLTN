...
/**
 * REST controller for managing {@link com.doantotnghiep.domain.Admin}.
 */
@RestController
@RequestMapping("/api")
public class AdminResource {
     ...
     */
    @GetMapping("/admins")
    public ResponseEntity<List<AdminDTO>> getAllAdmins(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
