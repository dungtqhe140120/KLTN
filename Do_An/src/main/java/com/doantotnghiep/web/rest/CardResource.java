...
import com.doantotnghiep.service.CardService;
...
/**
 * REST controller for managing {@link com.doantotnghiep.domain.Card}.
 */
@RestController
@RequestMapping("/api")
public class CardResource {
     ...
     */
    @GetMapping("/cards")
    public ResponseEntity<List<CardDTO>> getAllCards(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
