...
import com.doantotnghiep.service.CalendarService;
...
/**
 * REST controller for managing {@link com.doantotnghiep.domain.Calendar}.
 */
@RestController
@RequestMapping("/api")
public class CalendarResource {
    ...
    public ResponseEntity<List<CalendarDTO>> getAllCalendars(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
