...
class AdminResourceIT {
    ...
    public static Admin createEntity(EntityManager em) {
        Admin admin = new Admin().profile_id(DEFAULT_PROFILE_ID);
        return admin;
    }
    ...
    public static Admin createUpdatedEntity(EntityManager em) {
        Admin admin = new Admin().profile_id(UPDATED_PROFILE_ID);
        return admin;
    }
    ...
    void createAdmin() throws Exception {
        ...
        assertThat(testAdmin.getProfile_id()).isEqualTo(DEFAULT_PROFILE_ID);
    }
    ...
    void putNewAdmin() throws Exception {
        ...
        updatedAdmin.profile_id(UPDATED_PROFILE_ID);
        ...
        Admin testAdmin = adminList.get(adminList.size() - 1);
        assertThat(testAdmin.getProfile_id()).isEqualTo(UPDATED_PROFILE_ID);
    }
    ...
    void partialUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.profile_id(UPDATED_PROFILE_ID);
